...
const book = [
    ...
    {title : 'Book Ten' , genre : 'Friction' , publish : 2005 ,
        edition : 2006
    }
]

let userBooks = book.filter( (br) => br.genre === "History")

userBooks = book.filter( (br) => {
     return br.edition > 2000  && br.genre === "Friction"})
